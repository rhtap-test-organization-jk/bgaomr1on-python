...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/bgaomr1on-python-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-dm77m.dm77m.sandbox2102.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-dm77m.dm77m.sandbox2102.opentlc.com}
